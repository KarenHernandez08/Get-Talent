# Generated by Django 4.0.3 on 2022-06-17 01:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_id', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='vacantes.areasmodel')),
                ('empleador_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Empresa')),
                ('roles_id', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='vacantes.rolesmodel')),
            ],
            options={
                'db_table': 'Vacantes',
            },
